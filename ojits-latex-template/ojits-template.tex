...
openly archived under DOI \texttt{10.5281/zenodo.22965040}. Reported metrics are
...
% TODO biography pending: Lizandra Santos Morais
...
% TODO biography pending: Neraldo de Ara\'{u}jo Fontoura
...
% TODO biography pending: Matheus Bahia Silva
...
% TODO biography pending: Ta\'{i}s Souza de Andrade Soares
% TODO biography pending: Aline de Lurdes Zuliani Lunkes

\begin{IEEEbiographynophoto}{Aline de Lurdes Zuliani Lunkes}
Received the degree in Mathematics from the Federal University of Santa Maria (UFSM), Brazil, in 2015, the M.Sc. degree in Computational Modeling from the Federal University of Rio Grande (FURG), Brazil, in 2018, and the Ph.D. degree in Computational Modeling from the National Laboratory for Scientific Computing (LNCC), Brazil, in 2023. She is currently a Professor at the Federal University of Pampa (UNIPAMPA), Brazil. Her research interests include computational modeling, artificial intelligence, inverse problems, numerical methods, and scientific computing.
\end{IEEEbiographynophoto}
